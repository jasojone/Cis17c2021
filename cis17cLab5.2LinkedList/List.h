...
public:
    ...
    void accessLink(int num)
    {
        ...
        {
            linkPtr = head->lnkNext;
            cout << "Accessing the  " << head->data << 
            " from the linked list. It is already prioritized. " << endl; 
        }
        ...
        else 
        {
            ...
            //If linkPtr is not at the end of the list
            //link the previous link to the link after
            //linkPtr, then prioritize the link 
            if (linkPtr)
            {
                prevLink->lnkNext = linkPtr->lnkNext;
                cout << "Accessing the " << linkPtr->data << 
                " from the linked list and prioritizing "
                "it to the front of the list" << endl;
                head->lnkPrv = linkPtr;
                linkPtr->lnkNext = head;        
                head = linkPtr;
            }
        }
    }
